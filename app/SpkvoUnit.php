...
class SpkvoUnit extends CustomModel
{
    ...
    {
        return $this->belongsTo('App\UnitProgress');
    }

    public function templatepekerjaan()
    {
        return $this->belongsTo('App\Templatepekerjaan');
    }
    ...
    {
        return $this->belongsTo('App\SpkDetail', 'spk_detail_id');
    }
    ...
    {
        return $this->belongsTo('App\BapDetailItempekerjaan', 'id');
    }
