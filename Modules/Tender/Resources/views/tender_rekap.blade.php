                    ...
                    @foreach ( $tender->rekanans as $key3 => $value3 )
                      @if ( count($value3->penawarans) > 0 )
                        @foreach ( $value3->penawarans as $key4 => $value4 )
                          @if ( $key4 == $step )
                          <td style="text-align: right;">{{ number_format($value4->nilai,2) }}</td>
                          @endif
                        @endforeach
                      @else
                      @endif
                        ...
                        @foreach ( $value3->penawarans as $key4 => $value4 )
                          @if ( $key4 == $step )
                            @if ( $value3->rekanan->pkp_status == "1" )
                              <td style="text-align: right;">{{ number_format($ppn = 0,2) }}</td>
                            @else
                              <td style="text-align: right;">{{ number_format($ppn = 0.1 * $value4->nilai,2) }}</td>
                            @endif
                          @endif
                        @endforeach
                        @else
                        ...
                        @foreach ( $value3->penawarans as $key4 => $value4 )
                          @if ( $key4 == $step )
                            @if ( $value3->rekanan->pkp_status == "1" )
                              <td style="text-align: right;">{{ number_format($value4->nilai,2) }}</td>
                            @else
                              <td style="text-align: right;">{{ number_format( ($value4->nilai * 0.1 ) + $value4->nilai,2 ) }}</td>
                            @endif
                          @endif
                        @endforeach
                      @else
