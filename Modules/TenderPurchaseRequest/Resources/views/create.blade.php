              ...
              <form id="regForm" action="{{ url('/')}}/tenderpurchaserequest/add-tpr" method="post" enctype="multipart/form-data" name="form1">
                ...
                <div class="tab">
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <select id="tender_groups" class="form-input input col-md-12" name="t_pr_groups_id" required>
                      ...
                      @foreach($pengelompokanTender as $v )
                      <option value="{{ $v->id }}">{{"Id : ".$v->id." | Item : ".$v->itemName." | Brand : ".$v->brandName." | Quantity : ".$v->quantity." ".$v->itemSatuanName." | ".$v->description}}</option>
                      @endforeach
                    </select>
                  </div>
                ...
                <!-- <div id="form-tab-rekanan" class="">
                  <div id="rekanan_1" class="form-rekanan form-group col-md-12">
                    ...
                    <select name="t_pr_r_rekanan[]" class="form-selectize-rekanan input col-md-12" onchange="recomended_supplier(this.value,1)" required>
