                      ...
                      <div class="col-md-12">
                        ...
                        <div hidden>
                          ...
                          @foreach($rekanan as $v)
                              ...
                              <div class="col-md-3">
                                <input type="text" class="col-md-2 form-control" name="penawaran1[]" value="{{$penawaran[$j]->nilai1}}" style="text-align: right">
                              </div>
                              <div class="col-md-3">
                                <input type="text" class="col-md-2 form-control" name="penawaran2[]" value="{{$penawaran[$j]->nilai2}}" style="text-align: right" @if($penawaran[$j]->nilai1 == null) disabled @endif>
                              </div>
                              <div class="col-md-3">
                                <input type="text" class="col-md-2 form-control" name="penawaran3[]" value="{{$penawaran[$j]->nilai3}}" style="text-align: right" @if($penawaran[$j]->nilai2 == null) disabled @endif>
                              </div>
                              @php($j++)
                          @endforeach   
                      </div>
                  ...
                  <div class="tab-content">
                    <div id="rekanan" class="tab-pane fade in active">
                        <div class="row" style="margin-bottom:15px">
                          ...
                          <div class="col-md-2">
                              @if(strcmp($apporve->status,"approved")!=0 && $tender_approve != 6 and strcmp($user->user_login,"approval1")!=0)
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <form action="{{ url('/')}}/tenderpurchaserequest/add-pemenang">
                                ...
                                <button type="submit" class="btn btn-info form-control" >Tunjuk Sebagai Pemenang</button>
                            </form>
                            </td>
                          </tr>
                          @php($i++)
