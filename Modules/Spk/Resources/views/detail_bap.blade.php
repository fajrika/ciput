                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tr>
                        ...
                        <td style="text-align: right">
                         {{ number_format($bap->percentage,2) }} %
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <th>Nilai VO Sampai dengan ke-{{ $spk->baps->count() }}</th>
                      ...
                      <tr>
                        <th>Total Kontrak</th>
                        <td style="text-align: right">Rp. {{ number_format($spk->nilai_kumulatif + $ppn_kumulatif , 2) }}</td>
                      </tr>
