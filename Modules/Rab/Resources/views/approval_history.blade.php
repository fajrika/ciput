  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-default">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-12"><h3 class="box-title">Detail Data RAB <strong>{{ $rab->no }}</strong></h3></div>
   
            <!-- /.col -->
            <div class="col-md-12">

                <div class="form-group">                  
                  <a class="btn btn-warning" href="{{ url('/')}}/rab/detail/?id={{ $rab->id }}">Kembali</a>
                </div>
                {{ csrf_field() }}
                <table class="table">
                  ...
                  <tbody id="itemlist">
                    @foreach ( $rab->approval->histories as $key => $value )
                    @php
                      $array = array (
