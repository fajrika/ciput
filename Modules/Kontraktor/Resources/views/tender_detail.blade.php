                    ...
                    <table class="table table-bordered">
                      <thead class="head_table">
                        <tr>
                          ...
                          <td colspan="4">Penawaran 1</td>
                          <td colspan="4">Penawaran 2</td>
                          <td colspan="4">Penawaran 3</td>
                        </tr>
                        <tr>
                          <td>Volume</td>
                          <td>Satuan</td>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          @foreach($rekanan->penawarans as $key2 => $value2 )
                            @foreach( $value2->details as $key3 => $value3 )
                              @if ( $key2 == "0")
                                <td>{{ number_format($value3->nilai,2) }}</td>
                                <td>{{ number_format($value3->nilai * $value3->volume,2) }}</td>
                              @endif
                            @endforeach
                          @endforeach
